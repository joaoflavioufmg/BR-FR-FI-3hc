...
def make_br_flow_map():
    ...
    pontos_1 = read_csv('FR_Nivel_1.csv')    
    pontos_2 = read_csv('FR_Nivel_2.csv')    
    pontos_3 = read_csv('FR_Nivel_3.csv')
    pontos_4 = read_csv('FR_Nivel_4.csv') 
    ...
    fluxo_1 = read_csv('FR_fluxo_Nivel_1.csv')
    fluxo_2 = read_csv('FR_fluxo_Nivel_2.csv')
    fluxo_3 = read_csv('FR_fluxo_Nivel_3.csv')        
